					...
					<div class="wrap-post" >
						...
						<div class="entry-content" style="box-shadow: rgba(0, 0, 0, 0.7) 3px 3px 10px 1px;padding:20px;">		
							...
							<div class="excerpt">
								...
								<br>Our IT services are sure to benefit people from all backgrounds that want to use IT to grow their business. On times, where time and tides wait for none, we aim to bridge the gap between fast changing technology and Nepali Society. With an extremely creative team, we constantly see ourselves generating and implementing revolutionary ideas that aim to benefit the society as well as the organization.We hope to be the ultimate gateway for connecting the Nepali society with the emerging technologies at reasonable and affordable prices.
								<br><br>Let IT Grow is a team of enthusiastic young minds that want to make a difference by providing quality IT services to people all over Nepal regardless of where they come from.<br>You dictate, we Create.</p>
							</div>
						</div>							
					</div>
				</article>
